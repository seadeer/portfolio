...
var Circle = React.createClass({
    ...
    <svg width="100%" height="100%" viewBox="0 0 1150 800" version="1.1" xmlns="http://www.w3.org/2000/svg" style={styles}>
        {segs}
        <BasicText id="About" transform={labels.about.transform} x={labels.x} y={labels.y} text={labels.about.text} show={this.state.showId}/>
        ...
        <BasicText id="Projects" transform={labels.projects.transform} x={labels.x} y={labels.y} text={labels.projects.text} show={this.state.showId}/>
